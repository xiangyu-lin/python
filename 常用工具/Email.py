...
sendEmail(title='test toolz sendE',content='test',receivers=['xiangyu.lin@verycloud.cn'])
...
sender = 'wevie_9@163.com'                  # 发件人 最好写全 不然报错 (550, b'Invalid User', 'xiangyu.lin')
receivers = ['xiangyu.lin@verycloud.cn']    # 接收者邮箱 可多个

content = 'mail content'                    # 邮件内容
title = 'mail test'                         # 邮件标题
